...
pdf_folder = 'Reliance pdf'  # Adjust this path according to your folder structure

# Process all PDFs in the folder
all_extracted_data = process_pdfs_in_folder('Reliance pdf')

# Convert extracted data to DataFrame
df = pd.DataFrame(all_extracted_data)

# Output file path
output_excel_file = 'extracted_insurance_data.xlsx'
