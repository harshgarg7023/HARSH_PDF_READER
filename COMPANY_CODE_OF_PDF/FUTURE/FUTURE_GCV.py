...
def process_pdfs_in_folder(folder_path):
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith('.pdf'):
            ...
            details['File'] = filename  # Add filename as a key 'File'

            pdf_details.append(details)
    return pdf_details
...
def handle_gcv(data):
    # Process the data for Goods Carrying-Public Carriers
...
pdf_folder = r'C:\Users\user\PycharmProjects\PDF_READER\PDF CONTAINER\FUTURE PDF'


# Process all PDFs in the folder
pdf_details = process_pdfs_in_folder(pdf_folder)

# Specify output Excel file path
output_excel = r'C:\Users\user\PycharmProjects\PDF_READER\PDF CONTAINER\FUTURE PDF\future_good.xlsx'

# Save details to Excel
save_to_excel(pdf_details, output_excel)

print(f"Details extracted from PDFs in '{pdf_folder}' saved to '{output_excel}'.")
